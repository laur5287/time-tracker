...
export default async function AnalyticsPage({
	...
	return (
		<div className="container grid grid-cols-2 gap-4 pt-4 mx-auto">
			<div className="space-y-4">
				<h1 className="mb-2 text-lg font-medium">Analytics</h1>
				...
				{nullClientActivities.length > 0 && (
					<div>
						<h2 className="text-lg font-semibold">Activities whit No client</h2>
				...
				{clients.length > 0 && (
					...
					<ul className="">
						{clients.map((client) => (
							<li key={client.id}>
								<h2 className="text-lg text-red-500 font-semibold">{client.name}</h2>
								<ul>
			...
			<div className="space-y-4">
				...
				<DataCard className='' title='Client Breakdown' >
					<ClientChart data={clientData} />
				</DataCard>

				<DataCard className='' title='Activity  Breakdown' >
					<ActivityChart
